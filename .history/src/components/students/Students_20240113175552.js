...
const Students = () => {
    ...
    const inputRef = useRef(initForm);
    ...
    const addStudent = async () => {
        try {
            const update = await axios.post(GETALL,inputRef);
            return update.data;
        }
        catch (error) {
            console.log(error);
    ...
    const updateStudent = async () => {
        try {
            const update = await axios.put(`http://localhost:3003/students/${inputValue.id}`, inputRef);
            return update.data;
        }
        catch (error) {
            console.log(error);
