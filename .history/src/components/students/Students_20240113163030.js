...
const Students = () => {
    ...
    const [inputValue, setInputValue] = useState({ id: "", name: "", math:"", literature:"", english: ""});
    ...
    const editItem = (id) => {
        if(id > 0){
            document.getElementById("title-modal").innerHTML = "Cập nhật thông tin";
            ...
            document.getElementById("title-modal").innerHTML = "Tạo mới";
        }
                            ...
                            <div className="justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none bg-opacity-40">
                                ...
                                <div className="border-0 rounded-lg shadow-lg flex relative flex-col w-[550px] h-[670px] bg-white outline-none focus:outline-none">
                                    <div className='w-[450px] h-[600px] m-[50px]'>
                                        <h3 id="title-modal" className="text-center">Tạo mới</h3>
                                        ...
                                        <div className="flex gap-3 mt-8 pl-[155px]">
                                            ...
                                            <button className="w-[100px] h-[40px] border-solid border-2 bg-primary text-white">Cập nhật</button>
                                        </div>
                                    </div>
                                </div>
