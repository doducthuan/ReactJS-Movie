                            ...
                            <tbody>
                                {
                                    data.length > 0 ? data.map((item, index) => (
                                        <tr key={index}>
                                            ...
                                            <td>{item.english}</td>
                                            <td className='flex justify-center gap-2'><FaRegEdit className="icons text-[#22d3ee] text-xl cursor-pointer"/><MdDeleteOutline className="icons text-[#f43f5e] text-xl cursor-pointer"/></td>
                                        </tr>
