                        ...
                        <>
                            <div className="justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none bg-opacity-40">
                                {/* <div className="relative w-auto my-6 mx-auto max-w-3xl"> */}
                                    <div className="border-0 rounded-lg shadow-lg flex relative flex-col w-[700px] h-[500px] bg-white outline-none focus:outline-none">
                                        <div className='w-[600px] h-[400px] m-[50px]'>
