...
const Students = () => {
    ...
    const [finalForm, setFinalForm] = useState(initForm);
    ...
    const validateData = () => {
        setFinalForm({id:idRef.current.value, name: nameRef.current.value, math: mathRef.current.value, literature: literatureRef.current.value, english:englishRef.current.value})
