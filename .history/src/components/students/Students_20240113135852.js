...
const Students = () => {
    ...
    if (showModal) {
        document.getElementById("list-student").classList.add('active-modal')
    } else {
        document.getElementById("list-student").classList.remove('active-modal')
    }
    ...
    return (
        <div>
            <div className="full-view" id="list-student">
