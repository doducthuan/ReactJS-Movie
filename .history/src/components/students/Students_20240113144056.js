                                ...
                                <tbody>
                                    {
                                        data.length > 0 ? data.map((item, index) => (
                                            <tr key={index}>
                                                ...
                                                <td>
                                                <div>
                                                <FaRegEdit className="icons text-[#22d3ee] cursor-pointer" onClick={editItem(item.id)} />
                                                    <MdDeleteOutline className="icons text-[#f43f5e] cursor-pointer" onClick={deleteItem(item.id)} />
                                                </div>
