...
const Students = () => {
    ...
    const validateData = (finalForm) => {
        ...
        setFinalForm((finalForm) => {
            return {id:idRef.current.value, name: nameRef.current.value, math: mathRef.current.value, literature: literatureRef.current.value, english:englishRef.current.value}
        })
