    ...
    return (
        <div>
                ...
                <div className="border-data">
                    ...
                    <div className="table-data">
                        <div className="search-add mt-9 flex">
                            ...
                            <button className="add-student font-sans text-lg bg-cyan-500 hover:bg-cyan-600 text-white" onClick={() => setShowModal(!showModal)}>Thêm mới</button>
                        </div>
          ...
          <div className="modal-content">
            ...
            <button className="close-modal" onClick={() => setShowModal(!showModal)}>
              CLOSE
            </button>
          </div>
        </div>
